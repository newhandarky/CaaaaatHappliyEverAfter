import{a as s,_ as m}from"./config-1ccbba12.js";import"./admin_header-61c175db.js";import"./sweetalert2.all-daafc72c.js";const u=document.querySelector(".adminArticleList"),o=3;let d=1,c;function l(e){s.get(`${m}/article?_page=${e}&_limit=${o}`).then(function(t){c=t.data,p(),g(t.headers["x-total-count"])}).catch(t=>console.error("Error fetching data:",t))}l(d);function p(){let e="";c.forEach(function(t){localStorage.getItem("userRole")==="admin"&&(e+=`<tr>
