import{_ as $,a as T}from"./config-b31ac0c6.js";import{i as H}from"./navbar-da03776d.js";import"./aside-2c6a0e4f.js";import"./transform-4d2927c0.js";const L=document.querySelectorAll("#bookingHistory");L.forEach(k=>{k.classList.add("onThisPage")});const O=document.querySelector("#navAside");O.classList.remove("d-none");const M=JSON.parse(localStorage.getItem("userTokenAndData")),{accessToken:C,user:N}=M,h=document.getElementById("roomType");h.addEventListener("change",k=>{console.log(h.value),w()});function _(k,o){const I=(e,i,r,a,n,s,t,g,d,u,l)=>`<div class="orderBtns">
