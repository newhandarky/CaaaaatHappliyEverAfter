import{a as s,_ as m}from"./config-d9eb516d.js";import"./admin_header-8cd8039b.js";import"./sweetalert2.all-2959760f.js";const u=document.querySelector(".adminArticleList"),o=3;let d=1,c;function l(e){s.get(`${m}/article?_page=${e}&_limit=${o}`).then(function(t){c=t.data,p(),g(t.headers["x-total-count"])}).catch(t=>console.error("Error fetching data:",t))}l(d);function p(){let e="";c.forEach(function(t){localStorage.getItem("userRole")==="admin"&&(e+=`<tr>
