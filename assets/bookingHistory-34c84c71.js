import{_ as p,a as D}from"./config-33b8f4bf.js";import{i as w}from"./navbar-9de94bda.js";import"./aside-3a63331c.js";import"./transform-4d2927c0.js";const x=document.querySelectorAll("#bookingHistory");x.forEach(v=>{v.classList.add("onThisPage")});const H=JSON.parse(localStorage.getItem("userTokenAndData")),{accessToken:A,user:L}=H,h=document.getElementById("roomType");h.addEventListener("change",v=>{console.log(h.value),_()});function E(v,o){const y=(e,l,d,a,n,r,t,c,u,i,g)=>`<div class="orderBtns">
